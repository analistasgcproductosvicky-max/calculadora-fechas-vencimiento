...
function filtrarGlobal() {
  ...
  if (!query) { cerrarDropdownGlobal(); document.getElementById("globalResultado").style.display = "none"; return; }
...
function renderDropdownGlobal(lista, query) {
  ...
  // Agrupar por descripción única para el dropdown
...
// Cerrar dropdown global al hacer clic fuera
document.addEventListener("click", function(e) {
